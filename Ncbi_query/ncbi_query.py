...
def fetch_organism(idlist): #Según el id list en los registros recuperados se obtendrá la información a continuación de cada uno de los ID
    ...
    return moltype, topology, division, source, organism, taxonomy, sequence, total_a_nuc, total_c_nuc, total_g_nuc, total_t_nuc, locus, strand, id_record
 

def pandas_cvs(id_record, moltype, locus, strand, topology, division, source, organism, taxonomy, sequence, total_a_nuc, total_g_nuc, total_c_nuc, total_t_nuc):
    myDataDictionary={}
...
def main():
    ...
    idlist = rec["IdList"]
    moltype, topology, division, source, organism, taxonomy, sequence, total_a_nuc, total_c_nuc, total_g_nuc, total_t_nuc, locus, strand, id_record = fetch_organism(idlist)
    pandas_cvs(id_record, moltype, locus, strand, topology, division, source, organism, taxonomy, sequence, total_a_nuc, total_g_nuc, total_c_nuc, total_t_nuc)
